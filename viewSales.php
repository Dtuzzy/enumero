...
$teach = $conn->query("select * from sales order by date desc");
...
<div>
  ...
  <tr>
	 <th style="width:10%;">Item Sold</th>
  ...
  <?php
   while ($rows = mysqli_fetch_array($teach)) {
               ...
               echo "<tr>";
               echo "<td>".$rows['itemSold']."</td>";
               echo "<td>".$rows['price']."</td>";
			    echo "<td>".$rows['qtySold']."</td>";
				echo "<td>".$rows['qtyLeft']."</td>";
