...
$teach = $conn->query("select * from users");
...
if (isset($_POST['submit'])) {
		...
		if (mysqli_query($conn,$sql)){
					echo '<script type="text/javascript" language="Javascript">alert("User Has Been Removed.")
				</script>'; 
...
<form action="#" method="post">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="inputEmail4">Enter User's Phone Number</label>
                                <input type="text" class="form-control" name="phone"  placeholder="Enter Phone" id="inputEmail4" required="">
                            </div>
                            <div class="form-group col-md-6">
                               
                            </div>
							<button type="submit" name="submit" class="btn btn-primary">Remove User</button>
							</form>
