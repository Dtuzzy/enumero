...
if (isset($_POST['submit'])) {
    ...
    $clamp = "SELECT * FROM itemlist WHERE name='$lower'";
  ...
  `date` datetime NOT NULL
	...
	if (mysqli_num_rows($fake_sql) > 0) {
  	  echo '<script type="text/javascript" language="Javascript">alert("Sorry this code is already taken..")
			...
			$sql = "INSERT INTO itemlist(name, date) values ('".$lower."','".$now."')";

		if (mysqli_query($conn,$table) && mysqli_query($conn,$sql)){
					echo '<script type="text/javascript" language="Javascript">alert("Item Successfully added/ Field Created.")
				</script>';
		}else{
                    ...
                    <form action="#" method="post">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="name" id="inputEmail4" placeholder="Item Type" required="">
                            </div>
                        </div>
